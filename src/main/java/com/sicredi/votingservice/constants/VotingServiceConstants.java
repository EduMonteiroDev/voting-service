...
public class VotingServiceConstants {
    ...
    public static final String START_JOB_MESSAGE = "Preparing to inform the platform of the poll results...";
    public static final String FINALIZATION_JOB_MESSAGE = "The results have been pushed!";
